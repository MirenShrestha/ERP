    ...
    public partial class AgentReport : System.Web.UI.Page
    {
        protected void Page_Load(object sender, EventArgs e)
        {
            if (!Page.IsPostBack)
            {
                ...
                ReportViewer1.LocalReport.ReportPath = "D:\\Projects\\Sofwena\\Sofwena-ERP\\ERP1\\ERP.Web\\RDLC\\TicketingManagement\\AgentReport.rdlc";
                ...
                string agentId = Request.QueryString.Get("itemId");

                int agent_Id = Convert.ToInt32(agentId);
                ...
                DataTable dt = service.GetAgentReport(fDate, tDate,agent_Id);
                ...
                ReportDataSource datasource = new ReportDataSource("Agents", dt);
