...
{
    public partial class ItemBasedReport : System.Web.UI.Page
    {
        protected void Page_Load(object sender, EventArgs e)
        {
            if (!Page.IsPostBack)
            {
                ...
                ReportViewer1.LocalReport.ReportPath = "D:\\Projects\\Sofwena\\Sofwena-ERP\\ERP1\\ERP.Web\\RDLC\\TicketingManagement\\ItemWiseReport.rdlc";
                ...
                string itemId = Request.QueryString.Get("itemId");
                ...
                DataTable dt = service.ItemBasedReport(fDate, tDate, item_Id);
                ...
                ReportDataSource datasource = new ReportDataSource("ItemBasedReport", dt);
