    ...
    Dialog.prototype = {
        render: function() {
            ...
            switch (this.cfg.type) {
                ...
                case "confirm":
                    footerContent =
                        '<a class="lnv-btn-dialog default cancel-btn" id="ccancel-btn" href="javascript:;"><i class="fa fa-window-close-o"></i> ' + this.cfg.cancelBtnText + '</a>' +
                        '<a class="lnv-btn-dialog primary confirm-btn" class="true" id="confirm-btn" href="javascript:;"><i class="fa fa-check-square-o"></i> ' + this.cfg.confirmBtnText + '</a>';
                    break;
            }
            this.boundingBox = $(
